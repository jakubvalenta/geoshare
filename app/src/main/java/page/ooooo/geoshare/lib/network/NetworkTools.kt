...
interface NetworkTools {
    suspend fun httpHeadLocationHeader(url: URL, dispatcher: CoroutineDispatcher = Dispatchers.IO): String

    suspend fun httpGetRedirectedUrlString(url: URL, dispatcher: CoroutineDispatcher = Dispatchers.IO): String

    fun createClient(userConfig: HttpClientConfig<*>.() -> Unit = {}): HttpClient
}
...
class DefaultNetworkTools(
    ...
    override suspend fun httpHeadLocationHeader(url: URL, dispatcher: CoroutineDispatcher) =
     ...
     */
    @Throws(NetworkException::class)
    override suspend fun httpGetRedirectedUrlString(url: URL, dispatcher: CoroutineDispatcher) =
        withContext(dispatcher) {
            createClient()
                .get(url)
     ...
     */
    override fun createClient(userConfig: HttpClientConfig<*>.() -> Unit): HttpClient = HttpClient(engine) {
        userConfig()
...
open class FakeNetworkTools : NetworkTools {
    override suspend fun httpHeadLocationHeader(url: URL, dispatcher: CoroutineDispatcher): String =
        throw NotImplementedError()

    override suspend fun httpGetRedirectedUrlString(url: URL, dispatcher: CoroutineDispatcher): String =
        throw NotImplementedError()

    override fun createClient(userConfig: HttpClientConfig<*>.() -> Unit): HttpClient =
        throw NotImplementedError()
}
