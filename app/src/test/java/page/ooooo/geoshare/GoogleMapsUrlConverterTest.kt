...
class GoogleMapsUrlConverterTest {
    ...
    fun parseUrl_noPathOrKnownUrlQueryParams() {
        assertEquals(
            ParseUrlResult.RequiresHtmlParsingToGetCoords(Position(null, null)),
            googleMapsUrlConverter.parseUrl(URL("https://maps.google.com"))
        )
        assertEquals(
            ParseUrlResult.RequiresHtmlParsingToGetCoords(Position(null, null)),
            googleMapsUrlConverter.parseUrl(URL("https://maps.google.com/"))
        ...
        assertEquals(
            ParseUrlResult.RequiresHtmlParsingToGetCoords(Position(null, null)),
            googleMapsUrlConverter.parseUrl(URL("https://maps.google.com/?spam=1"))
        )
    }
    ...
    fun parseUrl_coordinatesOnly() {
        assertEquals(
            ParseUrlResult.Parsed(Position("52.5067296", "13.2599309", z = "6")),
    ...
    fun parseUrl_coordinatesOnlyStreetView() {
        assertEquals(
            ParseUrlResult.Parsed(Position("53.512825", "57.6891441")),
    ...
    fun parseUrl_placeAndPositiveCoordinates() {
        assertEquals(
            ParseUrlResult.Parsed(Position("52.5067296", "13.2599309", q = "Berlin, Germany", z = "11")),
    ...
    fun parseUrl_placeAndPositiveCoordinatesWithManyDecimalPlaces() {
        assertEquals(
            ParseUrlResult.Parsed(Position("44.448337599999995", "26.0834555")),
    ...
    fun parseUrl_placeAndNegativeCoordinates() {
        assertEquals(
            ParseUrlResult.Parsed(Position("-17.2165721", "-149.9470294", q = "Berlin, Germany", z = "11")),
    ...
    fun parseUrl_placeAndIntegerCoordinates() {
        assertEquals(
            ParseUrlResult.Parsed(Position("52", "13", q = "Berlin, Germany", z = "11")),
    ...
    fun parseUrl_placeAndFractionalZoom() {
        assertEquals(
            ParseUrlResult.Parsed(Position("52.5067296", "13.2599309", q = "Berlin, Germany", z = "6")),
    ...
    fun parseUrl_placeAndData() {
        assertEquals(
            ParseUrlResult.Parsed(Position("40.785091", "-73.968285", q = "Central Park", z = "15")),
    ...
    fun parseUrl_placeAndPositiveCoordinatesAndPositiveDataCoordinates() {
        assertEquals(
            ParseUrlResult.Parsed(Position("44.4490541", "26.0888398", z = "11")),
    ...
    fun parseUrl_placeAndNegativeCoordinatesAndNegativeDataCoordinates() {
        assertEquals(
            ParseUrlResult.Parsed(Position("40.785091", "-73.968285", z = "15")),
    ...
    fun parseUrl_placeAndPositiveDataCoordinates() {
        assertEquals(
            ParseUrlResult.Parsed(Position("44.4490541", "26.0888398")),
    ...
    fun parseUrl_placeAsCoordinates() {
        assertEquals(
            ParseUrlResult.Parsed(Position("52.04", "-2.35", z = "15")),
    ...
    fun parseUrl_placeAsCoordinatesWithPlus() {
        assertEquals(
            ParseUrlResult.Parsed(Position("52.492611", "13.431726", z = "17")),
    ...
    fun parseUrl_placeCoordinatesOnly() {
        assertEquals(
            ParseUrlResult.Parsed(Position("52.03877", "-2.3416")),
    ...
    fun parseUrl_placeOnly() {
        assertEquals(
            ParseUrlResult.RequiresHtmlParsingToGetCoords(
                Position(
                    null, null, q = "Poznań Old Town, 61-001 Poznań, Poland"
                )
            ),
    ...
    fun parseUrl_placeWithoutName() {
        assertEquals(
            ParseUrlResult.RequiresHtmlParsingToGetCoords(Position(null, null)),
            googleMapsUrlConverter.parseUrl(URL("https://www.google.com/maps/place//data=!4m2!3m1!1s0xc3f7d4e21a00705:0xa9ea51361ed84bda"))
        )
    }
    ...
    fun parseUrl_searchCoordinates() {
        assertEquals(
            ParseUrlResult.Parsed(Position("48.8584", "2.2945")),
    ...
    fun parseUrl_searchPlace() {
        assertEquals(
            ParseUrlResult.RequiresHtmlParsingToGetCoords(Position(null, null, q = "restaurants near me")),
    ...
    fun parseUrl_searchQueryCoordinates() {
        assertEquals(
            ParseUrlResult.Parsed(Position("47.5951518", "-122.3316393")),
            googleMapsUrlConverter.parseUrl(URL("https://www.google.com/maps/search/?query_place_id=ChIJKxjxuaNqkFQR3CK6O1HNNqY&query=47.5951518,-122.3316393&api=1"))
        )
    }
    ...
    fun parseUrl_searchQueryPlace() {
        assertEquals(
            ParseUrlResult.RequiresHtmlParsingToGetCoords(Position(null, null, q = "centurylink+field")),
    ...
    fun parseUrl_parameterQTakesPrecendence() {
        assertEquals(
            ParseUrlResult.Parsed(Position("40.7128", "-74.0060")),
            googleMapsUrlConverter.parseUrl(URL("https://www.google.com/?q=40.7128,-74.0060&viewpoint=34.0522,-118.2437"))
        )
        assertEquals(
            ParseUrlResult.Parsed(Position("40.7128", "-74.0060")),
            googleMapsUrlConverter.parseUrl(URL("https://www.google.com/?q=40.7128,-74.0060&center=34.0522,-118.2437"))
        )
    }
    ...
    fun parseUrl_parameterDestinationTakesPrecendence() {
        assertEquals(
            ParseUrlResult.RequiresHtmlParsingToGetCoords(Position(null, null, q = "Cherbourg,France")),
            googleMapsUrlConverter.parseUrl(URL("https://www.google.com/?destination=Cherbourg,France&q=Paris,France"))
        )
        assertEquals(
            ParseUrlResult.RequiresHtmlParsingToGetCoords(Position(null, null, q = "Cherbourg,France")),
            googleMapsUrlConverter.parseUrl(URL("https://www.google.com/?destination=Cherbourg,France&query=Paris,France"))
        )
    }
    ...
    fun parseUrl_directionsCoordinates() {
        assertEquals(
            ParseUrlResult.Parsed(Position("34.0522", "-118.2437")),
    ...
    fun toGeoUri_directionsFromToVia() {
        assertEquals(
            ParseUrlResult.RequiresHtmlParsingToGetCoords(Position(null, null, q = "Washington, DC")),
    ...
    fun toGeoUri_directionsFromToWithData() {
        assertEquals(
            ParseUrlResult.RequiresHtmlParsingToGetCoords(Position(null, null, q = "Potsdam")),
    ...
    fun parseUrl_apiCenter() {
        assertEquals(
            ParseUrlResult.Parsed(Position("-33.712206", "150.311941", z = "12")),
            googleMapsUrlConverter.parseUrl(URL("https://www.google.com/maps/@?api=1&map_action=map&center=-33.712206,150.311941&zoom=12&basemap=terrain"))
        )
    }
    ...
    fun parseUrl_apiCenterWithInvalidZoom() {
        assertEquals(
            ParseUrlResult.Parsed(Position("-33.712206", "150.311941")),
            googleMapsUrlConverter.parseUrl(URL("https://www.google.com/maps/@?api=1&map_action=map&center=-33.712206,150.311941&zoom=spam&basemap=terrain"))
        )
    }
    ...
    fun parseUrl_apiDirections() {
        assertEquals(
            ParseUrlResult.RequiresHtmlParsingToGetCoords(Position(null, null, q = "Cherbourg,France")),
            googleMapsUrlConverter.parseUrl(URL("https://www.google.com/maps/dir/?api=1&origin=Paris,France&destination=Cherbourg,France&travelmode=driving&waypoints=Versailles,France%7CChartres,France%7CLe%2BMans,France%7CCaen,France"))
        )
    }
    ...
    fun parseUrl_apiViewpoint() {
        assertEquals(
            ParseUrlResult.Parsed(Position("48.857832", "2.295226")),
            googleMapsUrlConverter.parseUrl(URL("https://www.google.com/maps/@?fov=80&pitch=38&heading=-45&viewpoint=48.857832,2.295226&map_action=pano&api=1"))
        )
    }
    ...
    fun parseUrl_qParameterCoordinates() {
        assertEquals(
            ParseUrlResult.Parsed(Position("48.857832", "2.295226")),
            googleMapsUrlConverter.parseUrl(URL("https://www.google.com/maps?foo=bar&q=48.857832,2.295226&spam"))
        )
    }
    ...
    fun parseUrl_qParameterCoordinatesWithTrailingSlash() {
        assertEquals(
            ParseUrlResult.Parsed(Position("48.857832", "2.295226")),
            googleMapsUrlConverter.parseUrl(URL("https://www.google.com/maps/?q=48.857832,2.295226"))
        )
    }
    ...
    fun parseUrl_qParameterCoordinatesWithEmptyPath() {
        assertEquals(
            ParseUrlResult.Parsed(Position("39.797573", "18.370173")),
    ...
    fun parseUrl_qParameterPlace() {
        assertEquals(
            ParseUrlResult.RequiresHtmlParsingToGetCoords(Position(null, null, q = "Central Park")),
            googleMapsUrlConverter.parseUrl(URL("https://www.google.com/maps?foo=bar&q=Central Park&spam"))
        )
    }
    ...
    fun parseUrl_googleSearch() {
        assertEquals(
            ParseUrlResult.RequiresHtmlParsingToGetCoords(Position(null, null)),
            googleMapsUrlConverter.parseUrl(URL("https://www.google.com/search?sca_esv=123&hl=en"))
        )
    }
    ...
    fun parseHtml_link() {
        ...
        assertEquals(
            ParseHtmlResult.Parsed(Position("44.4490541", "26.0888398")), googleMapsUrlConverter.parseHtml(html)
        )
    }
    ...
    fun parseHtml_array() {
        ...
        assertEquals(
            ParseHtmlResult.Parsed(Position("59.1293656", "11.4585672")), googleMapsUrlConverter.parseHtml(html)
        )
    }
