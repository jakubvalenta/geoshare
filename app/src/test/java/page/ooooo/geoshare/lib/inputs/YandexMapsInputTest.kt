...
class YandexMapsInputTest : BaseInputTest() {
    ...
    fun parseUri_noPathOrKnownUrlQueryParams() {
        assertNull(parseUriGetPosition("https://yandex.com"))
        assertNull(parseUriGetPosition("https://yandex.com/"))
        assertNull(parseUriGetPosition("https://yandex.com/maps"))
        assertNull(parseUriGetPosition("https://yandex.com/maps/?spam=1"))
    }
    ...
    fun parseUri_coordinates() {
        assertEquals(
            ...
            parseUriGetPosition("https://yandex.com/maps?ll=144.96315783657042%2C-37.81384550094835&z=17.852003")
        )
    }
    ...
    fun parseUri_coordinatesAndPoint() {
        assertEquals(
            Position(Srs.WGS84, -37.81384550131279, 144.96315783657045, z = 17.2),
            parseUriGetPosition("https://yandex.com/maps?whatshere%5Bpoint%5D=144.96315783657045%2C-37.81384550131279&whatshere%5Bzoom%5D=17.2&ll=144.96315783657042%2C-37.81384550094835&z=17.852003&si=6u8menx2bg23cfx27y7p1je8y8")
        )
    }
    ...
    fun parseUri_placeAndCoordinatesAndPoint() {
        assertEquals(
            ...
            parseUriGetPosition("https://yandex.com/maps/100513/osnabruck/?ll=8.055899%2C52.280743&mode=whatshere&whatshere%5Bpoint%5D=8.065475%2C52.294001&whatshere%5Bzoom%5D=13.24&z=15")
        )
    }
    ...
    fun parseUri_trDomain() {
        assertEquals(
            Position(Srs.WGS84, -37.81384550094835, 144.96315783657042, z = 17.852003),
            parseUriGetPosition("https://yandex.com.tr/maps?ll=144.96315783657042%2C-37.81384550094835&z=17.852003")
        )
    }
    ...
    fun parseHtml_containsDataCoordinates_returnsPosition() {
        assertEquals(
            Position(Srs.WGS84, 50.106376, 8.664164),
            parseHtmlGetPosition("""<html><div data-coordinates="8.664164,50.106376"></div></html>""")
        )
    }
    ...
    fun parseHtml_containsInvalidDataCoordinates_returnsNull() {
        assertNull(
            parseHtmlGetPosition("""<html><div data-coordinates="spam"></div></html>""")
        )
    }
