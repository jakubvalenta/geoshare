...
class ConversionStateTest {
    ...
    private val fakeLinkRepository: LinkRepository = FakeLinkRepository()
    ...
    fun receivedUri_inputDoesNotSupportShortUri_returnsUnshortenedUrlAndPassesPermission() = runTest {
        ...
        val mockInput = object : Input {
            ...
            override suspend fun parseUri(uri: Uri, uriQuote: UriQuote) = ParseUriResult.Succeeded(persistentListOf())
        }
    ...
    fun grantedUnshortenPermission_getLargeLoadingIndicator_retryIsNull_returnsIndicatorWithoutDescription() = runTest {
        ...
        assertEquals(
            ...
            state.getLargeLoadingIndicator(mockResources),
        )
    }
    ...
    fun unshortenedUrl_parseUriReturnsSucceeded_returnsConversionSucceeded() = runTest {
        ...
        val mockGoogleMapsInput: GoogleMapsInput = mock {
            on { parseUri(any(), any()) } doReturn ParseUriResult.Succeeded(points)
        }
        val mockUserPreferencesRepository: FakeUserPreferencesRepository = mock {
    ...
    fun unshortenedUrl_parseUriReturnsFailed_returnsConversionFailed() = runTest {
        ...
        val uri = Uri.parse(inputUriString, uriQuote)
        val mockGoogleMapsInput: GoogleMapsInput = mock {
            on { parseUri(any(), any()) } doReturn ParseUriResult.Failed()
        }
    ...
    fun unshortenedUrl_parseUriReturnsSucceededAndSupportsHtmlParsingAndPermissionIsAlways_returnsGrantedParseHtmlPermission() =
        runTest {
            ...
            val htmlUriString = "$inputUriString/html"
            val mockGoogleMapsInput: GoogleMapsInput = mock {
                on { parseUri(any(), any()) } doReturn ParseUriResult.SucceededAndSupportsHtmlParsing(
                    points,
                    htmlUriString
                )
            }
    ...
    @Test
    fun unshortenedUrl_parseUriReturnsSucceededAndSupportsWebParsingButInputDoesNotSupportWebParsing_returnsDeniedParseHtmlPermission() =
        runTest {
            val inputUriString = "https://maps.google.com/foo"
            val uri = Uri.parse(inputUriString, uriQuote)
            val points = persistentListOf<WGS84Point>()
            ...
            val mockInput = object : Input {
                ...
                override suspend fun parseUri(uri: Uri, uriQuote: UriQuote) =
                    ParseUriResult.SucceededAndSupportsWebParsing(points, webUriString)
            }
            val stateContext = mockStateContext(inputs = listOf(mockInput))
            val state = UnshortenedUrl(
                stateContext, inputUriString, mockInput, uri, Permission.ALWAYS
    ...
    @Test
    fun unshortenedUrl_parseUriReturnsSucceededAndSupportsWebParsingAndPermissionIsAlways_returnsGrantedParseWebPermission() =
        runTest {
            val inputUriString = "https://maps.google.com/foo"
            val uri = Uri.parse(inputUriString, uriQuote)
            val points = persistentListOf(WGS84Point(name = "bar"))
            val webUriString = "$inputUriString/web"
            val mockGoogleMapsInput: GoogleMapsInput = mock {
                on { parseUri(any(), any()) } doReturn ParseUriResult.SucceededAndSupportsWebParsing(
                    points,
                    webUriString
                )
            }
    ...
    @Test
    fun unshortenedUrl_parseUriReturnsSucceededAndSupportsWebParsingAndPermissionIsAsk_returnsRequestedParseWebPermission() =
        runTest {
            val inputUriString = "https://maps.google.com/foo"
            val uri = Uri.parse(inputUriString, uriQuote)
            val points = persistentListOf(WGS84Point(name = "bar"))
    ...
    @Test
    fun unshortenedUrl_parseUriReturnsSucceededAndSupportsWebParsingAndPermissionIsNever_returnsDeniedParseHtmlPermission() =
        runTest {
            val inputUriString = "https://maps.google.com/foo"
            val uri = Uri.parse(inputUriString, uriQuote)
            val points = persistentListOf(WGS84Point(name = "bar"))
    ...
    @Test
    fun unshortenedUrl_parseUriReturnsSucceededAndSupportsWebParsingAndPermissionIsNullAndPreferencePermissionIsAlways_returnsGrantedParseWebPermission() =
        runTest {
            val inputUriString = "https://maps.google.com/foo"
            val uri = Uri.parse(inputUriString, uriQuote)
            val points = persistentListOf(WGS84Point(name = "bar"))
    ...
    @Test
    fun unshortenedUrl_parseUriReturnsSucceededAndSupportsWebParsingAndPermissionIsNullAndPreferencePermissionIsAsk_returnsRequestedParseWebPermission() =
        runTest {
            val inputUriString = "https://maps.google.com/foo"
            val uri = Uri.parse(inputUriString, uriQuote)
            val points = persistentListOf(WGS84Point(name = "bar"))
    ...
    @Test
    fun unshortenedUrl_parseUriSucceededAndSupportsWebParsingAndUrlAndPermissionIsNullAndPreferencePermissionIsNever_returnsDeniedParseHtmlPermission() =
        runTest {
            val inputUriString = "https://maps.google.com/foo"
            val uri = Uri.parse(inputUriString, uriQuote)
            val points = persistentListOf(WGS84Point(name = "bar"))
    ...
    fun grantedParseWebPermission_isCancelled_returnsConversionFailed() = runTest {
        ...
        val state = GrantedParseWebPermission(
            stateContext, inputUriString, GoogleMapsInput, uri, pointsFromUri, webUriString
        )
    ...
    fun grantedParseWebPermission_isNotCancelledAndOnUrlChangeIsNotCalledWithinTimeout_returnsConversionFailed() =
        runTest {
            ...
            val stateContext = mockStateContext()
            val state = GrantedParseWebPermission(
                stateContext, inputUriString, GoogleMapsInput, uri, pointsFromUri, webUriString, timeout
            )
    ...
    @Test
    fun grantedParseWebPermission_urlChangeIsCalledAndUriPatternMatchesAndParseUriReturnsSucceeded_returnsConversionSucceeded() =
        runTest {
            val inputUriString = "https://maps.apple.com/foo"
            val uri = Uri.parse(inputUriString, uriQuote)
            val pointsFromUri = persistentListOf(WGS84Point(name = "bar"))
    ...
    @Test
    fun grantedParseWebPermission_urlChangeIsCalledAndUriPatternMatchesAndParseUriReturnsSucceededAndSupportsHtmlParsing_returnsConversionFailed() =
        runTest {
            val inputUriString = "https://maps.apple.com/foo"
            val uri = Uri.parse(inputUriString, uriQuote)
            val pointsFromUri = persistentListOf(WGS84Point(name = "bar"))
    ...
    @Test
    fun grantedParseWebPermission_urlChangeIsCalledAndUriPatternMatchesAndParseUriReturnsSucceededAndSupportsWebParsing_returnsConversionFailed() =
        runTest {
            val inputUriString = "https://maps.apple.com/foo"
            val uri = Uri.parse(inputUriString, uriQuote)
            val pointsFromUri = persistentListOf(WGS84Point(name = "bar"))
    ...
    @Test
    fun grantedParseWebPermission_urlChangeIsCalledAndUriPatternMatchesAndParseUriReturnsFailed_returnsConversionFailed() =
        runTest {
            val inputUriString = "https://maps.apple.com/foo"
            val uri = Uri.parse(inputUriString, uriQuote)
            val pointsFromUri = persistentListOf(WGS84Point(name = "bar"))
    ...
    fun conversionSucceeded_billingStatusIsLoadingAndCachedProductIsAKnownProduct_returnsActionReady() = runTest {
        ...
        val points = persistentListOf(WGS84Point(1.0, 2.0))
        val automation = CopyCoordsDecAutomation
        val action = automation.toOutput { defaultFakeLinks.findByUUID(it) }.toAction(points.last())
        val mockBilling: Billing = mock {
            on { status } doReturn MutableStateFlow(BillingStatus.Loading())
            on { products } doReturn persistentListOf(BillingProduct("test", BillingProduct.Type.ONE_TIME))
            on { features } doReturn persistentListOf(AutomationFeature)
    ...
    fun conversionSucceeded_userPreferenceAutomationIsOpenApp_returnsActionWaiting() = runTest {
        ...
        val action = automation.toOutput { defaultFakeLinks.findByUUID(it) }?.toAction(points.last())
            ?: throw AssertionError("Failed to create Output")
        val delay = 2.seconds
        val mockBilling: Billing = mock {
            on { status } doReturn MutableStateFlow(
                BillingStatus.Purchased(
    ...
    fun conversionSucceeded_userPreferenceAutomationIsSaveGpx_returnsActionWaiting() = runTest {
        ...
        val action = automation.toOutput { defaultFakeLinks.findByUUID(it) }.toAction(points)
        val delay = 2.seconds
        val mockBilling: Billing = mock {
            on { status } doReturn MutableStateFlow(
                BillingStatus.Purchased(
    ...
    fun actionWaiting_executionIsNotCancelled_waitsAndReturnsActionReady() = runTest {
        val inputUriString = "https://maps.google.com/foo"
        val points = persistentListOf(WGS84Point(1.0, 2.0))
        val action = SavePointsGpxOutput.toAction(points)
        val stateContext = mockStateContext()
    ...
    fun actionReady_actionIsCopyAutomation_returnsBasicActionReady() = runTest {
        val inputUriString = "https://maps.google.com/foo"
        val points = persistentListOf(WGS84Point(1.0, 2.0))
        val action = CopyCoordsDecOutput.toAction(points.last())
    ...
    fun actionReady_actionIsShareGpxRouteAutomation_returnsLocationRationaleRequested() = runTest {
        val inputUriString = "https://maps.google.com/foo"
        val points = persistentListOf(WGS84Point(1.0, 2.0))
        val action = OpenRouteOnePointGpxOutput(GOOGLE_MAPS_PACKAGE_NAME).toAction(points.last())
        val state = ActionReady(inputUriString, points, action, isAutomation = true)
        assertEquals(
    ...
    fun basicActionReady_returnsNull() = runTest {
        val inputUriString = "https://maps.google.com/foo"
        val points = persistentListOf(WGS84Point(1.0, 2.0))
        val action = SharePointsGpxOutput.toAction(points)
    ...
    fun locationActionReady_returnsNull() = runTest {
        ...
        val points = persistentListOf(WGS84Point(1.0, 2.0))
        val action = OpenRouteOnePointGpxOutput(GOOGLE_MAPS_PACKAGE_NAME).toAction(points.last())
        val state = LocationActionReady(inputUriString, points, action, isAutomation = false, WGS84Point(3.0, 4.0))
        assertNull(state.transition())
    }
    ...
    fun actionSucceeded_executionIsNotCancelled_waitsAndReturnsActionFinished() = runTest {
        val inputUriString = "https://maps.google.com/foo"
        val points = persistentListOf(WGS84Point(1.0, 2.0))
        val action = OpenDisplayGeoUriOutput(GOOGLE_MAPS_PACKAGE_NAME).toAction(points.last())
    ...
    fun locationRationaleRequested_returnsNull() = runTest {
        val inputUriString = "https://maps.google.com/foo"
        val points = persistentListOf(WGS84Point(1.0, 2.0))
        val action = OpenRouteOnePointGpxOutput(TOMTOM_PACKAGE_NAME).toAction(points.last())
    ...
    fun locationPermissionReceived_returnsNull() = runTest {
        ...
        val points = persistentListOf(WGS84Point(1.0, 2.0))
        val action = OpenRouteOnePointGpxOutput(TOMTOM_PACKAGE_NAME).toAction(points.last())
        val state = LocationPermissionReceived(inputUriString, points, action, isAutomation = false)
        assertNull(state.transition())
    }
    ...
    fun locationPermissionReceived_getSmallLoadingIndicator_returnsLoadingIndicator() = runTest {
        ...
        assertEquals(
            ...
            state.getSmallLoadingIndicator(mockResources),
        )
    }
