...
class CoordinatesOutputGroupTest {
    ...
    fun copyOutput_returnsSouthWestForNegativeCoordinates() {
        assertEquals(
            ...
            outputGroup.getActionOutputs().first().getAction(Position(Srs.WGS84, -17.2165721, -149.9470294), uriQuote),
        )
    }
    ...
    fun copyOutput_returnsNorthEastForPositiveCoordinates() {
        assertEquals(
            ...
            outputGroup.getActionOutputs().first().getAction(Position(Srs.WGS84, 52.5067296, 13.2599309), uriQuote),
        )
    }
    ...
    fun copyOutput_returnsZerosForZeroCoordinates() {
        assertEquals(
            ...
            outputGroup.getActionOutputs().first().getAction(Position(Srs.WGS84, 0.0, 0.0), uriQuote),
        )
    }
    ...
    fun copyOutput_returnsZeroDegForZeroDegCoordinates() {
        assertEquals(
            ...
            outputGroup.getActionOutputs().first().getAction(Position(Srs.WGS84, 0.5, 0.5), uriQuote),
        )
    }
    ...
    fun copyOutput_returnsZeroMinForZeroMinCoordinates() {
        assertEquals(
            ...
            outputGroup.getActionOutputs().first().getAction(Position(Srs.WGS84, -10.0, -20.0), uriQuote)
        )
    }
    ...
    fun copyOutput_returnsZerosSecForZeroSecCoordinates() {
        assertEquals(
            ...
            outputGroup.getActionOutputs().first().getAction(Position(Srs.WGS84, -10.5, -20.5), uriQuote)
        )
    }
