...
class AmapInputTest : BaseInputTest() {
    ...
    fun parseUri_inChina() = runTest {
        assertEquals(
            ParseUriResult.Succeeded(Position(Srs.GCJ02, 31.222811749011463, 121.46840706467624)),
    ...
    fun parseUri_notInChina() = runTest {
        assertEquals(
            ParseUriResult.Succeeded(Position(Srs.GCJ02, 45.8289525077221, 1.266689300537103)),
