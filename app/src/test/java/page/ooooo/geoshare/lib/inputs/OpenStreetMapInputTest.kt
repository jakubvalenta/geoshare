...
class OpenStreetMapInputTest : InputTest {
    override val input = OpenStreetMapUriInput
    ...
    fun uriPattern_unknownScheme() {
        assertEquals(
            ...
            getUri("ftp://www.openstreetmap.org/#map=16/51.49/-0.13"),
        )
    }
    ...
    fun parseUri_element() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(),
                htmlUriString = "https://www.openstreetmap.org/api/0.6/node/6284640534.json",
            ),
        ...
        assertEquals(
            ParseUriResult(
                persistentListOf(),
                htmlUriString = "https://www.openstreetmap.org/api/0.6/relation/910699/full.json",
            ),
        ...
        assertEquals(
            ParseUriResult(
                persistentListOf(),
                htmlUriString = "https://www.openstreetmap.org/api/0.6/way/596674456/full.json",
            ),
