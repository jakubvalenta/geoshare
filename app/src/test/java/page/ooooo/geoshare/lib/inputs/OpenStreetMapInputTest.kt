...
class OpenStreetMapInputTest : BaseInputTest() {
    ...
    fun parseUri_coordinates() = runTest {
        assertEquals(
            ParseUriResult.Succeeded(WGS84Point(51.49, -0.13, z = 16.0)),
    ...
    fun parseUri_directions() = runTest {
        assertEquals(
            ParseUriResult.Succeeded(WGS84Point(51.0528, 13.7364)),
    ...
    fun parseUri_shortLink() = runTest {
        assertEquals(
            ParseUriResult.Succeeded(WGS84Point(51.510772705078125, 0.054931640625, z = 9.0)),
    ...
    fun parseUri_shortLinkNegative() = runTest {
        assertEquals(
            ParseUriResult.Succeeded(WGS84Point(-16.23152732849121, -49.08348083496094, z = 11.0)),
