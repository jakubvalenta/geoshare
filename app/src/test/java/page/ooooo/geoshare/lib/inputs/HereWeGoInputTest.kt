...
class HereWeGoInputTest : BaseInputTest() {
    ...
    fun parseUri_coordinatesPath() = runTest {
        assertEquals(
            ParseUriResult.Succeeded(WGS84Point(52.536213398175434, 13.417085409306102)),
    ...
    fun parseUri_coordinatesQueryParam() = runTest {
        assertEquals(
            ParseUriResult.Succeeded(WGS84Point(50.21972, -0.68453, z = 6.93)),
    ...
    fun parseUri_place() = runTest {
        assertEquals(
            ParseUriResult.Succeeded(WGS84Point(52.68444319987284, -8.623429663612297)),
    ...
    fun parseUri_placeAndCoordinates() = runTest {
        assertEquals(
            ParseUriResult.Succeeded(WGS84Point(52.68444319987284, -8.623429663612297, z = 16.0)),
    ...
    fun parseUri_shortLink() = runTest {
        assertEquals(
            ParseUriResult.Succeeded(WGS84Point(-38.14749, 145.14347)),
