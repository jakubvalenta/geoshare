...
class HereWeGoInputTest : BaseInputTest() {
    ...
    fun parseUri_noPathOrKnownUrlQueryParams() {
        ...
        assertEquals(
            Position() to null,
            parseUri("https://wego.here.com/?spam=1")
        )
    }
    ...
    fun parseUri_coordinatesPath() {
        assertEquals(
            Position(Srs.WGS84, 52.536213398175434, 13.417085409306102) to null,
    ...
    fun parseUri_coordinatesQueryParam() {
        assertEquals(
            Position(Srs.WGS84, 50.21972, -0.68453, z = 6.93) to null,
    ...
    fun parseUri_place() {
        assertEquals(
            Position(Srs.WGS84, 52.68444319987284, -8.623429663612297) to null,
    ...
    fun parseUri_placeAndCoordinates() {
        assertEquals(
            Position(Srs.WGS84, 52.68444319987284, -8.623429663612297, z = 16.0) to null,
    ...
    fun parseUri_shortLink() {
        assertEquals(
            Position(Srs.WGS84, -38.14749, 145.14347) to null,
