...
class GoogleMapsInputTest : InputTest {
    ...
    override val input = GoogleMapsInput(uriFormatter)
    ...
    fun uriPatternAndShortUriPattern_matchesShortUriWithQueryString() {
        ...
        assertEquals(
            ...
            getShortUri("https://maps.app.goo.gl/foo?g_st=isi"),
        )
    }
    ...
    fun uriPatternAndShortUriPattern_matchesShortUriWithInvalidTrailingCharacters() {
        ...
        assertEquals(
            ...
            getShortUri("https://maps.app.goo.gl/jVuuNEZ_-FQ3UGhX7%3C/a%3E%3C/p%3E"),
        )
    }
    ...
    fun uriPatternAndShortUriPattern_matchesShortUriWithLinkParam() {
        ...
        assertNull(
            getShortUri("https://maps.app.goo.gl/?utm_campaign=ml-navnp-dr&pcampaignid=ml-navnp-dr&apn=com.google.android.apps.maps&amv=965100030&link=https%3A%2F%2Fwww.google.com%2Fmaps%2Fdir%2F%2FThe%2BStation%2C%2B1%2BMends%2BSt%2C%2BSouth%2BPerth%2BWA%2B6151%2F%40-31.9614112%2C115.8523381%2C14z%2Fdata%3D!4m6!4m5!1m0!1m2!1m1!1s0x2a32a529928d7447%3A0x4a1084749ffdee05!3e0!11m1!6b1%3Fentry%3Dml%26utm_campaign%3Dml-navnp-dr%26coh%3D230964&isi=585027354&ibi=com.google.Maps&ius=comgooglemapsurl&pt=9008&mt=8&ct=ml-navnp-dr&ifl=https%3A%2F%2Fapps.apple.com%2Fapp%2Fid585027354%3Fct%3Dml-navnp-dr%26pt%3D9008%26mt%3D8%26ppid%3Da2beb448-b2c7-4ed7-ae8b-78fdcf9f33a8&efr=1")
        )
    }
    ...
    fun parseUri_noPathOrKnownUrlQueryParams() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(),
                htmlUriString = "https://maps.google.com",
            ),
        ...
        assertEquals(
            ParseUriResult(
                persistentListOf(),
                htmlUriString = "https://maps.google.com/?spam=1",
            ),
    ...
    fun parseUri_unknownPath() = runTest {
        assertEquals(ParseUriResult(), parseUri("https://maps.google.com/spam"))
    }
    ...
    fun parseUri_coordinatesOnly() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(
                    GoogleMapsPoint(52.5067296, 13.2599309, z = 6.0, source = Source.MAP_CENTER)
                )
            ),
    ...
    fun parseUri_coordinatesInChina() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(
                    GoogleMapsPoint(31.22850685422705, 121.47552456472106, z = 11.0, source = Source.MAP_CENTER)
                )
            ),
    ...
    fun parseUri_coordinatesInChinaNearCoast() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(
                    GoogleMapsPoint(30.60283, 122.12886, z = 11.0, source = Source.MAP_CENTER)
                )
            ),
    ...
    fun parseUri_coordinatesOnlyStreetView() = runTest {
        assertEquals(
            ParseUriResult(persistentListOf(GoogleMapsPoint(53.512825, 57.6891441, source = Source.MAP_CENTER))),
    ...
    fun parseUri_placeAndNegativeCoordinatesAndNegativeDataCoordinates() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(
                    GoogleMapsPoint(40.785091, -73.968285, z = 15.0, name = "Central Park", source = Source.URI)
                )
            ),
    ...
    fun parseUri_placeAsCoordinates() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(GoogleMapsPoint(52.04, -2.35, z = 15.0, source = Source.URI))
            ),
    ...
    fun parseUri_placeAsCoordinatesWithPlus() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(GoogleMapsPoint(52.492611, 13.431726, z = 17.0, source = Source.URI))
            ),
    ...
    fun parseUri_placeCoordinatesOnly() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(GoogleMapsPoint(52.03877, -2.3416, source = Source.URI))
            ),
    ...
    fun parseUri_placeOnly() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(GoogleMapsPoint(name = "Poznań Old Town, 61-001 Poznań, Poland", source = Source.URI)),
    ...
    fun parseUri_placeWithoutName() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(),
                htmlUriString = "https://www.google.com/maps/place//data=!4m2!3m1!1s0xc3f7d4e21a00705%3A0xa9ea51361ed84bda",
            ),
    ...
    fun parseUri_placeList() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(),
                htmlUriString = "https://www.google.com/maps/placelists/list/abcdef?g_ep=ghijkl%3D&g_st=isi",
            ),
    ...
    fun parseUri_placeListInData() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(),
                htmlUriString = @Suppress("SpellCheckingInspection") "https://www.google.com/maps/@/data=!3m1!4b1!4m3!11m2!2sXXXYYY!3e3?skid=foo&g_ep=bar&entry=tts",
            ),
            parseUri(@Suppress("SpellCheckingInspection") "https://www.google.com/maps/@/data=!3m1!4b1!4m3!11m2!2sXXXYYY!3e3?skid=foo&g_ep=bar&entry=tts"),
        )
    }
    ...
    fun parseUri_searchCoordinates() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(GoogleMapsPoint(48.8584, 2.2945, source = Source.URI))
            ),
    ...
    fun parseUri_searchPlace() = runTest {
        assertEquals(
            ParseUriResult(persistentListOf(GoogleMapsPoint(name = "restaurants near me", source = Source.URI))),
    ...
    fun parseUri_searchQueryCoordinates() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(GoogleMapsPoint(47.5951518, -122.3316393, source = Source.URI))
            ),
    ...
    fun parseUri_parameterLlTakesPrecedenceOverViewpointAndCenter() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(GoogleMapsPoint(49.93556240, -7.30123395, source = Source.URI))
            ),
    ...
    fun parseUri_parameterQTakesPrecedenceOverLlAndViewpointAndCenter() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(GoogleMapsPoint(40.7128, -74.0060, source = Source.URI))
            ),
    ...
    fun parseUri_parameterDestinationTakesPrecedence() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(GoogleMapsPoint(name = "Cherbourg,France", source = Source.URI)),
    ...
    fun parseUri_directionsCoordinates() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(
                    GoogleMapsPoint(40.7128, -74.0060, source = Source.URI),
                    GoogleMapsPoint(34.0522, -118.2437, source = Source.URI),
                )
            ),
    ...
    fun parseUri_directionsCoordinatesWithCenter() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(
                    GoogleMapsPoint(40.7128, -74.0060, source = Source.URI),
                    GoogleMapsPoint(34.0522, -118.2437, z = 16.0, source = Source.URI),
                )
            ),
    ...
    fun parseUri_directionsPlaceAndCoordinates() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(
                    GoogleMapsPoint(name = "My location", source = Source.URI),
                    GoogleMapsPoint(
                        48.83887481689453,
                        2.2740750312805176,
                        z = 8.0,
            ...
            parseUri(@Suppress("SpellCheckingInspection") "https://www.google.com/maps/dir/My+location/H%c3%b4pital+Europ%c3%a9en+Georges+Pompidou+Assistance+Publique-H%c3%b4pitaux+de+Paris,20+r+Leblanc%2c+75015+Paris/@48.83887481689453,2.2740750312805176,8z/"),
        )
    }
    ...
    fun parseUri_directionsFromTo() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(
                    GoogleMapsPoint(name = "New York, NY", source = Source.URI),
                    GoogleMapsPoint(name = "Los Angeles, CA", source = Source.URI),
                ),
    ...
    fun parseUri_directionsFromToWithInvalidData() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(
                    GoogleMapsPoint(name = "Berlin", source = Source.URI),
                    GoogleMapsPoint(name = "Potsdam", source = Source.URI),
                ),
    ...
    fun parseUri_directionsFromToVia() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(
                    GoogleMapsPoint(name = "New York, NY", source = Source.URI),
                    GoogleMapsPoint(name = "Philadelphia, PA", source = Source.URI),
                    GoogleMapsPoint(name = "Washington, DC", source = Source.URI),
                ),
    ...
    fun parseUri_directionsFromToViaWithCenter() = runTest {
        assertEquals(
            ...
            parseUri(@Suppress("SpellCheckingInspection") "https://www.google.com/maps/dir/Hermannstra%C3%9Fe+1,+12049+Berlin,+Germany/Weserstr.+1,+12047+Berlin,+Germany/Reuterstra%C3%9Fe+1,+Berlin-Neuk%C3%B6lln,+Germany/@52.4844406,13.4217121,16z/"),
        )
    }
    ...
    fun parseUri_directionsAddressWithSpace() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(GoogleMapsPoint(name = "2088 Albion Rd @43.7481,-79.6332", source = Source.URI)),
    ...
    fun parseUri_directionsEmpty() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(),
                htmlUriString = "https://www.google.com/maps/dir/",
            ),
    ...
    @Test
    fun parseUri_directionsEmptyPathPart() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(
                    GoogleMapsPoint(
    ...
    fun parseUri_streetView() = runTest {
        assertEquals(
            ParseUriResult(persistentListOf(GoogleMapsPoint(48.8584, 2.2945, source = Source.MAP_CENTER))),
    ...
    fun parseUri_apiCenterWithInvalidZoom() = runTest {
        assertEquals(
            ParseUriResult(persistentListOf(GoogleMapsPoint(-33.712206, 150.311941, source = Source.MAP_CENTER))),
    ...
    fun parseUri_apiDirections() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(
                    GoogleMapsPoint(name = "Paris,France", source = Source.URI),
                    GoogleMapsPoint(name = "Cherbourg,France", source = Source.URI),
                ),
    ...
    fun parseUri_apiViewpoint() = runTest {
        assertEquals(
            ParseUriResult(persistentListOf(GoogleMapsPoint(48.857832, 2.295226, source = Source.MAP_CENTER))),
    ...
    fun parseUri_qParameterCoordinates() = runTest {
        assertEquals(
            ParseUriResult(persistentListOf(GoogleMapsPoint(48.857832, 2.295226, source = Source.URI))),
    ...
    fun parseUri_qParameterCoordinatesWithEmptyPath() = runTest {
        assertEquals(
            ParseUriResult(persistentListOf(GoogleMapsPoint(39.797573, 18.370173, source = Source.URI))),
    ...
    fun parseUri_qParameterPlace() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(GoogleMapsPoint(name = "Central Park", source = Source.URI)),
    ...
    fun parseUri_qParameterEmpty() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(),
                htmlUriString = "https://www.google.com/maps",
            ),
    ...
    @Test
    fun parseUri_googleMapsGo() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(
                    GoogleMapsPoint(
            ...
            parseUri("https://maps.app.goo.gl/?utm_campaign=ml-navnp-dr&pcampaignid=ml-navnp-dr&apn=com.google.android.apps.maps&amv=965100030&link=https%3A%2F%2Fwww.google.com%2Fmaps%2Fdir%2F%2FThe%2BStation%2C%2B1%2BMends%2BSt%2C%2BSouth%2BPerth%2BWA%2B6151%2F%40-31.9614112%2C115.8523381%2C14z%2Fdata%3D!4m6!4m5!1m0!1m2!1m1!1s0x2a32a529928d7447%3A0x4a1084749ffdee05!3e0!11m1!6b1%3Fentry%3Dml%26utm_campaign%3Dml-navnp-dr%26coh%3D230964&isi=585027354&ibi=com.google.Maps&ius=comgooglemapsurl&pt=9008&mt=8&ct=ml-navnp-dr&ifl=https%3A%2F%2Fapps.apple.com%2Fapp%2Fid585027354%3Fct%3Dml-navnp-dr%26pt%3D9008%26mt%3D8%26ppid%3Da2beb448-b2c7-4ed7-ae8b-78fdcf9f33a8&efr=1"),
        )
    }

    @Test
    fun parseUri_googleSearch() = runTest {
        assertEquals(ParseUriResult(), parseUri("https://www.google.com/search?sca_esv=123&hl=en"))
    }
    ...
    fun parseUri_myMaps() = runTest {
        assertEquals(
            ParseUriResult(
                persistentListOf(),
                htmlUriString = "https://www.google.com/maps/d/edit?mid=abcdef",
            ),
        ...
        assertEquals(
            ParseUriResult(
                persistentListOf(),
                htmlUriString = "https://www.google.com/maps/d/viewer?mid=abcdef",
            ),
    ...
    fun parseHtml_link() = runTest {
        assertEquals(
            ParseHtmlResult(persistentListOf(GoogleMapsPoint(44.4490541, 26.0888398, source = Source.JAVASCRIPT))),
            parseHtml(
...
"""
    ...
    fun parseHtml_whenHtmlContainsGenericMetaTagAndAppInitState_returnsRequiresWebParsing() = runTest {
        assertEquals(
            ParseHtmlResult(webUriString = "https://www.google.com/maps/place/Berlin,+Germany/"),
            parseHtml(
                @Suppress("SpellCheckingInspection")
    ...
    fun parseHtml_directionsPreview() = runTest {
        assertEquals(
            ParseHtmlResult(persistentListOf(GoogleMapsPoint(43.7481, -79.6332, source = Source.HTML))),
            parseHtml(
                @Suppress("SpellCheckingInspection")
...
[null,null,43.7481,-79.6332]...[null,[-79.6332,43.7481]"""
    ...
    fun parseHtml_placeList() = runTest {
        assertEquals(
            ParseHtmlResult(
                persistentListOf(
                    GoogleMapsPoint(59.1293656, 11.4585672, source = Source.JAVASCRIPT),
                    GoogleMapsPoint(59.4154007, 11.659710599999999, source = Source.JAVASCRIPT),
                    GoogleMapsPoint(59.147731699999994, 11.550661199999999, source = Source.JAVASCRIPT)
                )
            ),
            parseHtml(
                @Suppress("SpellCheckingInspection")
...
"""
    ...
    fun parseHtml_myMaps() = runTest {
        assertEquals(
            ParseHtmlResult(
                persistentListOf(
                    GoogleMapsPoint(52.49016, 13.434500000000071, source = Source.JAVASCRIPT),
                    GoogleMapsPoint(52.49534999999999, 13.431890000000067, source = Source.JAVASCRIPT),
                    GoogleMapsPoint(52.4901894, 13.433825899999988, source = Source.JAVASCRIPT),
                    GoogleMapsPoint(52.4898201, 13.433602800000017, source = Source.JAVASCRIPT),
                    GoogleMapsPoint(52.4960741, 13.435130399999935, source = Source.JAVASCRIPT),
                    GoogleMapsPoint(52.4961778, 13.422070500000018, source = Source.JAVASCRIPT),
                    GoogleMapsPoint(52.49514559999999, 13.423243800000023, source = Source.JAVASCRIPT),
                    GoogleMapsPoint(52.497884, 13.429134, source = Source.JAVASCRIPT),
                    GoogleMapsPoint(52.4957432, 13.43344819999993, source = Source.JAVASCRIPT),
                )
            ),
            parseHtml(
                @Suppress("SpellCheckingInspection")
...
"""
    ...
    fun parseHtml_placeListOnePoint() = runTest {
        assertEquals(
            ParseHtmlResult(persistentListOf(GoogleMapsPoint(59.1293656, 11.4585672, source = Source.JAVASCRIPT))),
            parseHtml(
                @Suppress("SpellCheckingInspection")
                """<html>
<head>
...
"""
    ...
    fun parseHtml_googleSearchHtmlContainsRelativeUrl_returnsRequiresRedirect() = runTest {
        assertEquals(
            ParseHtmlResult(
                redirectUriString = @Suppress("SpellCheckingInspection") "/maps/place//data=!4m2!3m1!1s0xc3f7d4e21a00705:0xa9ea51361ed84bda?sa=X&amp;ved=2ahUKEwiY7vv80aeKAxU41QIHHSgBOlsQ4kB6BAgHEAA&amp;hl=de&amp;gl=de",
            ),
            parseHtml(
                @Suppress("SpellCheckingInspection")
                """<html>
...
"""
    ...
    fun parseHtml_googleSearchHtmlContainsAbsoluteUrl_returnsRequiresRedirect() = runTest {
        assertEquals(
            ParseHtmlResult(redirectUriString = "https://www.example.com/foo"),
