...
import page.ooooo.geoshare.tests.retryTest
...
class BaiduMapInputBehaviorTest : InputBehaviorTest {
    ...
    fun baiduMap_offline() = uiAutomator {
        ...
        testUri(
            ...
            "https://map.baidu.com/poi/%E5%9C%B0%E5%9B%BE%E4%B8%8A%E7%9A%84%E7%82%B9/@13522176,2865337,17z?querytype=share&poiShareId=pb81fb1b0172f25114bd52ce2cd&da_src=shareurl",
        )
