...
class InitialLinksTest : InitialDataTest {
    ...
    fun initialLinksAreInserted() = runBlocking {
        ...
        val expectedItems = listOf(
            ...
            Link(
                name = @Suppress("GrazieInspectionRunner", "SpellCheckingInspection") "KartaView",
                type = LinkType.STREET_VIEW,
                appEnabled = false,
            ...
            Link(
                name = @Suppress("GrazieInspectionRunner", "SpellCheckingInspection") "Mapilio",
                type = LinkType.STREET_VIEW,
                appEnabled = false,
            ...
            Link(
                name = @Suppress("GrazieInspectionRunner", "SpellCheckingInspection") "Panoramax",
                type = LinkType.STREET_VIEW,
                appEnabled = false,
