...
class GoogleMapsInputBehaviorTest : BaseInputBehaviorTest() {
    ...
    fun test() {
        ...
        // Coordinates in data
        testUri(
            Position(Srs.WGS84, 52.4083009, 16.929066199999998),
        ...
        testUri(
            Position(Srs.WGS84, 40.785091, -73.968285, z = 15.0),
        ...
        testUri(
            Position(Srs.WGS84, 50.4484901, 8.0469828),
        ...
        // Directions
        testUri(
            Position(Srs.WGS84, 52.4807739, 13.4300356, z = 16.0),
            @Suppress("SpellCheckingInspection")
