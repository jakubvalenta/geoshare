...
class GoogleMapsInputBehaviorTest : InputBehaviorTest {
    ...
    fun googleMaps() = uiAutomator {
        ...
        testUri(
            GCJ02Point(39.9168038, 116.3971621, name = "Forbidden City"),
        ...
        // Center
        testUri(
            GCJ02Point(52.5067296, 13.2599309, z = 11.0, name = "Berlin, Germany"),
            "https://www.google.com/maps/place/Berlin,+Germany/@52.5067296,13.2599309,11z/",
        )

        // API
        testUri(
            GCJ02Point(52.5067296, 13.2599309),
    ...
    fun googleMapsHtml() = uiAutomator {
        ...
        // Short URI in Japan
        testUri(
            GCJ02Point(34.5945482, 133.7583428, z = 17.0, name = "Steak no Don"),
