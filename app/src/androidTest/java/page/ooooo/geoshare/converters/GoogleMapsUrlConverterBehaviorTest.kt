...
class GoogleMapsUrlConverterBehaviorTest : BaseUrlConverterBehaviorTest() {
    ...
    fun test() {
        ...
        // Coordinates in data
        testUri(
            Position(52.4083009, 16.929066199999998),
        ...
        // Short URI
        testUri(
            Position(52.4842015, 13.4167277),
        ...
        // Directions
        testUri(
            Position(52.4807739, 13.4300356, z = 16.0),
            @Suppress("SpellCheckingInspection")
        ...
        // Text
        testUri(
            Position(52.5067296, 13.2599309),
